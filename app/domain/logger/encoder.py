...
def zoneinfo_encoder(zoneinfo_value: ZoneInfo) -> str:
    """Encodes a ZoneInfo as str"""
    return zoneinfo_value.key
...
def jsonable_encoder(  # noqa: PLR0911, PLR0912, C901
    obj: Annotated[
        Any,
        Doc(
            """
